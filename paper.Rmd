...
* FLoA~RCB_Roislien~ : Roislien approach (Get one random stride from each subject ONCE and boot-
       strap the resulting sample (of length (n=length(subjects))
       
* FLoA~RCB_Point~ : Pointwise B & A Limits of Agreement
...
* 4. FLoA~RCB_Roislien~ : Roislien approach (Get one random stride from each subject ONCE and boot-
       strap the resulting sample (of length (n=length(subjects))

* 5. FLoA~RCB_Point~ : Pointwise B & A Limits of Agreement

Coverages are displayed for two different scenarios:

* 1: Coverage of the entire curve

* 2: Percentage of curve points within the respective FLoA
...
Percentage of curve points within the respective FLoA
