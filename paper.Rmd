...
* (3) Heteroscedastic error: Heteroscedasticity across the signal length. The example consists of knee moment curves calculated using two different methods (direct and inverse kinematic approach) (Robinson et al., 2014). The curves were recreated using the example code provided in Robinson et al. (2021).
...
#### Heteroscedasticity across the signal length (Robinson et al., 2014)
